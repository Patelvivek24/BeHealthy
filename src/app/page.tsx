      ...
      <section className={styles.hero}>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.heroStats}>
            ...
            <div className={styles.heroStat}>
              <div className={styles.heroStatNumber}>1M+</div>
              <div className={styles.heroStatLabel}>Workouts Completed</div>
            </div>
            <div className={styles.heroStat}>
              <div className={styles.heroStatNumber}>100K+</div>
              <div className={styles.heroStatLabel}>Reports Analyzed</div>
            </div>
            <div className={styles.heroStat}>
              <div className={styles.heroStatNumber}>4.8<span className={styles.starIcon}>★</span></div>
      ...
      <section className={styles.section}>
        <div className={styles.container}>
          ...
          <p className={styles.sectionText}>
            ...
            lifestyle through personalized diet plans, guided workouts, habit tracking, medical 
            reminders, vital monitoring, and smart medical report analysis — all in one app.
          </p>
        </div>
      </section>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.featuresGrid}>
            <div className={styles.featureCard}>
              ...
              <p>Custom meal plans tailored to your goals, preferences, and dietary needs.</p>
            </div>
            <div className={styles.featureCard}>
              ...
              <h3>Workout Library & Guided Exercises</h3>
              <p>Access hundreds of workouts with step-by-step video guidance and form tips.</p>
            </div>
            <div className={styles.featureCard}>
              ...
              <h3>Habit & Water Intake Tracking</h3>
              <p>Build healthy habits with daily tracking and reminders for water intake.</p>
            </div>
            <div className={styles.featureCard}>
              <div className={`${styles.featureIcon} ${styles.iconGreen}`}>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <h3>BP / Sugar / BMI / Heart Rate Monitoring</h3>
              <p>Track vital signs and health metrics with easy-to-use monitoring tools.</p>
            </div>
            <div className={styles.featureCard}>
              <div className={`${styles.featureIcon} ${styles.iconTeal}`}>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <p>Get instant insights from your medical reports with AI-powered analysis.</p>
            </div>
            <div className={styles.featureCard}>
              <div className={`${styles.featureIcon} ${styles.iconBlue}`}>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <h3>Reminders & Daily Health Tasks</h3>
              <p>Never miss a medication, workout, or health check with smart reminders.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.gamificationGrid}>
            ...
            <div className={styles.gamificationCard}>
              ...
              <p>Build consistency with daily activity tracking</p>
            </div>
            <div className={styles.gamificationCard}>
              ...
              <h3>Leaderboards</h3>
              <p>Compete with friends and the community</p>
            </div>
            <div className={styles.gamificationCard}>
              <div className={`${styles.gamificationIcon} ${styles.iconGreen}`}>
                <svg viewBox="0 0 24 24" fill="currentColor">
              ...
              <h3>Level Up</h3>
              <p>Progress through levels as you improve</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.pricingGrid}>
            ...
            <div className={styles.pricingCard}>
              ...
              <button className={styles.pricingCTA}>Start Free Trial</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className={styles.newsletterSection}>
        <div className={styles.container}>
          <div className={styles.newsletterCard}>
            <h2 className={styles.newsletterTitle}>Stay Updated with BeHealthy</h2>
          ...
          <div className={styles.footerContent}>
            <div className={styles.footerSection}>
              <div className={styles.footerLogoPlaceholder}>
                <Image src="/images/new-logo.png" alt="BeHealthy Logo" width={120} height={120} />
              </div>    
